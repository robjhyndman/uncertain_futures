...
for(i in seq_along(prob)) {
  ...
  p2 <- tibble(
      ...
      geom_line(aes(x=y, y=Q), col='red',linetype=2,
        data=tibble(y=c(actual,actual), Q=c(13.5,qpactual[i]))
      ) +
      geom_line(aes(x=y, y=Q), col='red',linetype=2,
...
for(i in seq_along(prob)) {
  ...
  p1 <- gamma %>%
    ...
    geom_line(aes(x=y, y=f), col='red', linetype=2,
      data=tibble(y=rep(actual,2), f=c(0,-0.1))
    ) +
    geom_line(aes(x=y, y=f), col='blue',linetype=2,
  ...
  p2 <- tibble(
    ...
    geom_line(aes(x=y, y=Q), col='red',linetype=2,
      data=tibble(y=c(actual,actual), Q=c(12,qpactual))
    ) +
    geom_line(aes(x=y, y=Q), col='red',linetype=2,
